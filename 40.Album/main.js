...
function make_album(artist_name, album_artist, tracks) {
    var album = {
        artist: artist_name,
        album: album_artist,
    };
...
var album1 = make_album("Pritam", "Singh Is King");
var album2 = make_album("Ustad Vilayat Khan", "Ranga Darbari");
var album3 = make_album("Anoushka Shankar", "Land of Gold", 9);
console.log(album1);
console.log(album2);
console.log(album3);
