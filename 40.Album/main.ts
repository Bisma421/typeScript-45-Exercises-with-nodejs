...
function make_album(artist_name: string, album_artist: string, tracks? :number){
...
let album1 = make_album("Pritam","Singh Is King");
let album2 = make_album("Ustad Vilayat Khan", "Ranga Darbari");
let album3 = make_album("Anoushka Shankar", "Land of Gold", 9 );
